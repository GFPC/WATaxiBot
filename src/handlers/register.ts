  ...
  switch (state?.state) {
    ...
    case "collectionLegalInformation":
      if(ctx.message.body === "1"){
        ...
        state.data.docs.legalInformationExpanded = !state.data.docs.legalInformationExpanded;
        ...
        await state.data.docs.legalInformationMessage?.edit(
            ctx.constants.getPrompt(
                ...
                state.data.docs.legalInformationExpanded ? ctx.constants.getPrompt(localizationNames.legal_information_big,state.data.lang.api_id,) : '',
            ).replace('%action%',ctx.constants.getPrompt(
                    state.data.docs.legalInformationExpanded ? localizationNames.collapse_doc : localizationNames.expand_doc,
                    state.data.lang.api_id,
                ))
        )
    ...
    case "collectionPrivacyPolicy":
      if(ctx.message.body === "1"){
        ...
        state.data.docs.privacyPolicyExpanded = !state.data.docs.privacyPolicyExpanded;
        ...
        await state.data.docs.privacyPolicyMessage?.edit(
            ctx.constants.getPrompt(
                ...
                state.data.docs.privacyPolicyExpanded ? ctx.constants.getPrompt(localizationNames.privacy_policy_big,state.data.lang.api_id) : '',
            )
                .replace('%action%',ctx.constants.getPrompt(
                    state.data.docs.privacyPolicyExpanded ? localizationNames.collapse_doc : localizationNames.expand_doc,
                    state.data.lang.api_id,
                ))
        )
    ...
    case "collectionPublicOffers":
      if(ctx.message.body === "1"){
        ...
        state.data.docs.publicOffersExpanded = !state.data.docs.publicOffersExpanded;
        ...
        await state.data.docs.publicOffersMessage?.edit(
          ctx.constants.getPrompt(
            ...
            state.data.lang.api_id,
              ...
              state.data.docs.publicOffersExpanded ? ctx.constants.getPrompt(localizationNames.public_offers_big,state.data.lang.api_id,) : '',
              )
              .replace('%action%',ctx.constants.getPrompt(
                  state.data.docs.publicOffersExpanded ? localizationNames.collapse_doc : localizationNames.expand_doc,
                  state.data.lang.api_id,
              ))
        )

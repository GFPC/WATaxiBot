...
export class ConfigManager {
    configsMap: { [key: string]: { login: string; password: string; type: string; } };
    urlManager: { [key: string]: string } = {};
    constructor(configsMap: { [key: string]: { login: string; password: string; type: string; } }, urlManager: { [key: string]: string; }) {

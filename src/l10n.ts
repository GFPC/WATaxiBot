...
export const localization = {
  ...
  error:
    "Произошла непредвиденная ошибка. Попробуйте повторить ещё раз или отменить заказ, написав ( *0* ).",
  ...
  public_offers: "*Публичная оферта*.\nЕсли согласны - введите ( *1* ), если нет - введите ( *0* ).",
  privacy_policy: "*Политика конфиденциальности*.\nЕсли согласны - введите ( *1* ), если нет - введите ( *2* ).",
  legal_information: "*Юридическая информация*.\nЕсли согласны - введите ( *1* ), если нет - введите ( *2* ).",
  reject_terms: "Вы не приняли условия сервиса и не можете использовать его. В любой момент вы можеет согласиться с условиями, введя ( *1* ).",

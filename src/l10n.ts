...
export const localization = {
  ...
  sendRefCode: "Отлично! Теперь отправьте промокод. Если его нет, то напишите ( *0* )",
  ...
  tooManyPeople: "Слишком много людей в заказе. Укажите меньшее кол-во или отмените заказ, написав ( *0* ).",
  tooFewPeople: "Кол-во людей не может быть меньше 1. Укажите большее кол-во или отмените заказ, написав ( *0* ).",
  ...
  confirmPrompt: "Отправьте ( *1* ) чтобы подтвердить заказ или ( *0* ) чтобы его отменить.",
  ...
  rateSet: "Оценка успешно поставлена. Вы можете ввести текстовый комментарий под этим сообщением, для отмены напишите ( *0* )",
  ...
  votingExtended: "Время голосования продлено на 3 минуты. Отправьте ( *2* ) для продления или ( *0* ) для отмены. ",
  driverArrived: "Водитель уже прибыл и ожидает вас, его номер телефона: %phone%",
  driverCanceled: "Водитель отменил заказ. Для остановки поиска напишите ( *0* )\nПоиск машины...",
  ...
  enterStartPoint: "Отправьте адрес начальной точки. Чтобы отменить заказ, в любой момент напишите ( *0* )",
  ...
  newReferralCodeCollection: "Введите реферальный код, для отмены введите ( *0* )",
  ...
  selectAdditionalOptions: "Выберите дополнительные опции из списка ниже, укажите цифрами через пробел, если не требуются, введите ( *00* ):",
  ...
  startPriceExtended: 'Чаевые расширены, текущая сумма: %price% %currency%\n' +
      '\nПродолжается поиск машины...',
  helpStartPoint: "📍 *Выбор начальной точки*\n\n📝 На данном этапе доступны следующие варианты команд:\n1. Отправьте конкретный адрес в виде текста, голосового сообщения или геолокации.\n2. Отправьте код места или фото с QR-кодом.\n3. Напишите ( *01* ), чтобы выбрать из списка сохранённых мест.\n4. Напишите ( *02* ), чтобы выбрать район из справочника.\n\nЧтобы отменить заказ, в любой момент напишите ( *0* ).",
  helpEndPoint: "📍 *Выбор конечной точки*\n\n📝 На данном этапе доступны следующие варианты команд:\n1. Отправьте конкретный адрес в виде текста, голосового сообщения или геолокации.\n2. Отправьте код места или фото с QR-кодом.\n3. Напишите ( *01* ), чтобы выбрать из списка сохранённых мест.\n4. Напишите ( *02* ), чтобы выбрать район из справочника.\n\nЧтобы отменить заказ, в любой момент напишите ( *0* ).",
  settingsTestModeHint: "📝 Для перехода в режим тестирования нажмите смените реферальный код на *test*",
  settingsTestModeActive: "📝 Тестовый режим активирован. Отключить тестовый режим можно сменой реферального кода на предыдущее значение, оно указано в настройках",
  settingsPreviousReferralCode: "📝 Предыдущий реферальный код: %code%",
  settingsExitTestModeError: "❌ В тестовом режиме недоступна смена реферального кода на значения, не равные предыдущему. Чтобы выйти из тестового режима смените реферальный код на предыдущее значение, оно указано в настройках",
...
export const localizationNames = {
  ...
  settingsPreviousReferralCode: "wab_settingsPreviousReferralCode".toLowerCase(),
